% =====================================================================
%  Data Mining · SGH · SMMD-ADA / SMMD-AAB   —   Block 6 slide deck
...
\begin{frame}{Next week: how the presentation works}
  \begin{itemize}
    ...
    \item \textbf{The AI rule}: assistants were allowed all semester, but
          you answer for every submitted line. Submissions are read for
          the fingerprints of \alert{unchecked generation} - conventions
          nobody can explain, claims the notebook does not compute. The
          more the project feels written \emph{solely} by AI, the
          \alert{harder the questions} - expect to explain and modify
          your code live.
